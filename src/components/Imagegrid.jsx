...
const Imagegrid = () => {
  ...
  return (
    ...
    <h1 className="text-center bg-[#2B4141] py-4 text-white text-2xl md:text-4xl font-bold mb-8">explore most popular places</h1>
      ...
      <img src="https://images.unsplash.com/photo-1507608869274-d3177c8bb4c7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODl8fHRyYXZlbHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60" alt="" title="thailand" className='max-w-full h-auto rounded-md md:hover:scale-95 duration-300 cursor-pointer'/>
      <img src="https://images.unsplash.com/photo-1501446529957-6226bd447c46?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODd8fHRyYXZlbHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60" alt="" title="bali" className='max-w-full h-auto rounded-md md:hover:scale-95 duration-300 cursor-pointer'/>
